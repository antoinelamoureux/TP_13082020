...
<html lang="fr">
  ...
  <header></header>
  <h1>Afficher les commandes par client</h1>
  <hr>
  <form method = "post" action="clientsorders.php">
       <label>Saisissez le nom du client: </label>
...
<?php
   ...
   if(!empty($_POST['contact_name'])) {
      ...
      $client = $idcom->escape_string($_POST['contact_name']);

$requete = "SELECT * FROM orders INNER JOIN customers ON orders.ship_name = customers.contact_name WHERE orders.ship_name = '$client'";
